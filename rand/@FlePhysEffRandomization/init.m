...
% AE 2008-09-03
% MS 2012-01-16/2012-04-21/2012-08-15/2012-09-04/2013-09-17
% parameters that are randomized
r.conditions = struct('isFlash',{},'isMoving',{},'isStop',{},'isInit',{}, 'isReverse',{}, ...
...
if ~params.combined % Single condition
    for i = 1:size(params.barColor,2)
        for angle = params.trajectoryAngle
            ...
            if params.flashInit || params.flashStop || params.flashReverse
            ...
            for iDx = 1:length(params.dx)
                ...
                for dir = params.direction
                    ...
                    % Flash reversed condition
                    if params.flashReverse
                        r.conditions(end+(1:nLocs)) = ...
                            struct('isFlash',0, ...
                            'isMoving',1, ...
                            'isStop',0, ...
