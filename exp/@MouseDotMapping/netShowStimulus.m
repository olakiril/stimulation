...
for k = 1:stimFrames*nFrames
    ...
    if firstFrame
        ...
        behTime = getParam(e,'behaviorTimestamp');
        tcpReturnFunctionCall(e,int32(0),struct('correctResponse',int32(1),...
            'trialdata',int32([dotLocations{i}; behTime])),'netShowStimulus');
